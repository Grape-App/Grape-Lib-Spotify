...
class ArtistService @Inject()(
  ...
  private val getArtistUrl: String = configString("services.spotify.artist.getArtistUrl")
  private val getArtistsUrl: String = configString("services.spotify.artist.getArtistsUrl")
  private val getArtistRelatedArtistsUrl: String = configString("services.spotify.artist.getArtistRelatedArtistsUrl")
   ...
   */
  def getArtist(artistId: String): ServiceResult[Artist] = wsLog
    .get[Artist](String.format(getArtistUrl, artistId))
   ...
   */
  def getArtists(artistIds: Seq[String]): ServiceResult[Seq[Artist]] = wsLog
    .get[Seq[Artist]](String.format(getArtistsUrl, artistIds.mkString(",")))(Artist.readsSeq)
  ...
  def getArtistAlbums(artistId: String): ServiceResult[Seq[Album]] =
    wsLog
      .get[Seq[Album]](String.format(getArtistsUrl, artistId))(Album.readsSeq)
