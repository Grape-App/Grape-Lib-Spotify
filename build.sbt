...
val PROJECT_NAME = "Grape-Lib-Spotify"
...
scmInfo := Some(ScmInfo(
  url("https://github.com/Grape-App/Grape-Lib-Spotify.git"),
  "scm:git:git@github.com:Grape-App/Grape-Lib-Spotify.git"
))
...
libraryDependencies ++= Seq(
  ws,
  "rocks.grape" %% "grape-commons" % "0.1.1",
